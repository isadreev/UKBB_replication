...
p4 <- grid.arrange(
	mylegend, arrangeGrob(p1 + theme(legend.position="none") + labs(x="", title="A"),
                p2 + theme(legend.position="none") + labs(x="", title="B"),
                p3 + theme(legend.position="none") + labs(x="Relative discovery sample size", title="C"),
                nrow=3),
